...
/**
 * REF-22: create the table only when missing; always apply guarded SQLite
 * partial unique indexes after create.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        if ($driver === 'sqlite') {
            if (! Schema::hasIndex('death_requests', 'death_requests_one_pending')) {
                DB::statement(
            ...
            if (! Schema::hasIndex('death_requests', 'death_requests_one_approved')) {
                DB::statement(

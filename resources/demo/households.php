...
if (! function_exists('lml_demo_member_display')) {
    function lml_demo_member_display(array $member, string $key): string
    {
        ...
        if ($key === 'occupation' && ($member['occupation'] ?? '') === 'Other') {
            $custom = trim((string) ($member['occupation_other'] ?? ''));

            return $custom !== '' ? $custom : 'Other';
        }

        if ($key === 'religion' && ($member['religion'] ?? '') === 'Other') {
            $custom = trim((string) ($member['religion_other'] ?? ''));
    ...
    'HH-152' => [
        ...
        'memberList' => [
            ...
            [
                ...
                'middle_name' => 'M.',
                'relation' => 'Daughter',
                'birthday' => \Carbon\Carbon::now()->startOfDay()->subYears(19)->toDateString(),
                'relationship_status' => 'Single',
                'monthly_income' => 'None / N/A',
                'religion' => 'Roman Catholic',
                'education' => 'High School Graduate',
                'philhealth' => '223456789013',
                'fp_user' => 'No',
                'disability' => ['none'],
                'disability_others' => '',
                'medical_history' => ['none'],
            ...
            [
                ...
                'middle_name' => 'M.',
                'relation' => 'Son',
                'birthday' => \Carbon\Carbon::now()->startOfDay()->subYears(18)->toDateString(),
                'relationship_status' => 'Single',
                'monthly_income' => 'None / N/A',
                'religion' => 'Roman Catholic',
                'education' => 'High School Graduate',
                'philhealth' => '223456789014',
                'fp_user' => 'No',
                'disability' => ['none'],
                'disability_others' => '',
                'medical_history' => ['none'],

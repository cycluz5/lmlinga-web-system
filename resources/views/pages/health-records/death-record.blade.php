                ...
                <section class="lml-hr-death-form__card" aria-labelledby="lml-hr-death-view-title">
                    ...
                    <dl class="lml-hr-death-form__details">
                        ...
                        <div>
                            ...
                            <dd>{{ $deathRequest->displayRegistryNo() !== '' ? $deathRequest->displayRegistryNo() : $emptyRecord }}</dd>
                        </div>
                        <div>
                            <dt>Verification Status</dt>
                            <dd>{{ $deathRequest->statusLabel() }}</dd>
                        </div>
                        <div>
                            <dt>Submitted by</dt>
                        ...
                        <div>
                            <dt>Submitted on</dt>
                            <dd>{{ \App\Support\DisplayDate::formatDateTime($deathRequest->submitted_at) }}</dd>
                        </div>
                    </dl>
                    ...
                    <div class="lml-hr-death-form__file-item">
                        ...
                        <a
                            ...
                            aria-label="View death certificate {{ $deathRequest->displayCertificateFileName() }}"
                        >
                            <i class="bi bi-file-earmark-text" aria-hidden="true"></i>
                            <span>{{ $deathRequest->displayCertificateFileName() !== '' ? $deathRequest->displayCertificateFileName() : 'Death certificate' }}</span>

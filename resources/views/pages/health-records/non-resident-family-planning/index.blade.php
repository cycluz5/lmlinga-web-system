{{--
    Health Records → Family Planning → Non-Residents listing.
    Filters are client-side. Export downloads a PDF of persisted clients.
--}}
...
@section('content')
    ...
    <div
        ...
        data-export-url="{{ route('health-records.family-planning.non-residents.export') }}"
    >
                                    ...
                                    <td class="lml-hr-fp-nr__cell lml-hr-fp-nr__cell--actions">
                                        <div class="lml-hr-fp-nr__row-actions" role="group" aria-label="Actions for {{ $client['full_name'] }}">
                                            ...
                                            <button
                                                ...
                                                data-delete-url="{{ route('health-records.family-planning.non-residents.destroy', ['clientKey' => $client['key']]) }}"

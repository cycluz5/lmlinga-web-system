{{--
    ...
    Data: App\Support\HealthRecordsVitaminA — nutrition_supplementation / child nutrition records.
    Zone/year/month filters reload server-side aggregates. Export Data lands on the
    Report Builder (child-care-vitamin-a-report-builder.blade.php) first.
--}}
...
@section('content')
    @php
        ...
        $rows = $rows ?? [];
        $zones = $zones ?? [];
        $years = $years ?? HealthRecordsVitaminA::years();
    ...
    <div
        ...
        data-va-data-mode="persisted"
        data-page-url="{{ $vitaminAUrl }}"
        data-export-url="{{ route('health-records.child-care.vitamin-a.report-builder') }}"
    >
        <div class="lml-hr-child-care__panel">
            ...
            <div class="lml-hr-child-care__filters lml-hr-child-care__filters--vitamin-a" role="toolbar" aria-label="Vitamin A filters">
                <div class="lml-hr-child-care__search">
                    <label class="visually-hidden" for="lml-hr-va-search">Search age group</label>
                ...
                <div class="lml-hr-child-care__select-wrap">
                    <label class="visually-hidden" for="lml-hr-va-year">Filter by year</label>
                    <select
                        id="lml-hr-va-year"
                        class="lml-hr-child-care__select lml-focus-ring"
                        data-hr-va-year
                ...
                <div class="lml-hr-child-care__select-wrap">
                    <label class="visually-hidden" for="lml-hr-va-month">Filter by month</label>
                    <select
                        id="lml-hr-va-month"
                        class="lml-hr-child-care__select lml-focus-ring"
                        data-hr-va-month
            ...
            <p class="visually-hidden" data-hr-va-zone-status aria-live="polite">
                Zone, year, and month filters apply to database-backed Vitamin A aggregates.
            </p>

            <p class="lml-hr-child-care__results visually-hidden" data-hr-va-results aria-live="polite"></p>
                    ...
                    <table class="lml-hr-child-care__table lml-hr-child-care__table--vitamin-a">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" rowspan="3" class="lml-hr-va-th lml-hr-va-th--target" data-hr-va-sortable aria-sort="none">
                                    <button type="button" class="lml-hr-va-sort-btn" data-hr-va-sort="target">
                                ...
                                <th scope="col" rowspan="3" class="lml-hr-va-th lml-hr-va-th--pct" data-hr-va-sortable aria-sort="none">
                                    <button type="button" class="lml-hr-va-sort-btn" data-hr-va-sort="percentage">
                                        <span class="lml-hr-va-th__stack">
                            ...
                            <tr>
                                <th scope="col" class="lml-hr-va-th lml-hr-va-th--sex" data-hr-va-sortable aria-sort="none">
                                    <button type="button" class="lml-hr-va-sort-btn" data-hr-va-sort="va_100k_male">
                                        <span>Male</span>
                                    </button>
                                </th>
                                <th scope="col" class="lml-hr-va-th lml-hr-va-th--sex" data-hr-va-sortable aria-sort="none">
                                    <button type="button" class="lml-hr-va-sort-btn" data-hr-va-sort="va_100k_female">
                                        <span>Female</span>
                                    </button>
                                </th>
                                <th scope="col" class="lml-hr-va-th lml-hr-va-th--sex" data-hr-va-sortable aria-sort="none">
                                    <button type="button" class="lml-hr-va-sort-btn" data-hr-va-sort="va_100k_total">
                                        <span>Total</span>
                                    </button>
                                </th>
                                <th scope="col" class="lml-hr-va-th lml-hr-va-th--sex" data-hr-va-sortable aria-sort="none">
                                    <button type="button" class="lml-hr-va-sort-btn" data-hr-va-sort="va_200k_male">
                                        <span>Male</span>
                                    </button>
                                </th>
                                <th scope="col" class="lml-hr-va-th lml-hr-va-th--sex" data-hr-va-sortable aria-sort="none">
                                    <button type="button" class="lml-hr-va-sort-btn" data-hr-va-sort="va_200k_female">
                                        <span>Female</span>
                                    </button>
                                </th>
                                <th scope="col" class="lml-hr-va-th lml-hr-va-th--sex" data-hr-va-sortable aria-sort="none">
                                    <button type="button" class="lml-hr-va-sort-btn" data-hr-va-sort="va_200k_total">
                                        <span>Total</span>
                                    </button>
                                </th>
                            </tr>
                        ...
                        <tbody>
                            @foreach ($rows as $row)
                                ...
                                >
                                    ...
                                    <td class="lml-hr-va-cell lml-hr-va-cell--num" data-value="{{ $row['target'] }}">
                                    ...
                                    <td class="lml-hr-va-cell lml-hr-va-cell--num" data-value="{{ $row['va_100k_male'] }}">
                                    ...
                                    <td class="lml-hr-va-cell lml-hr-va-cell--num" data-value="{{ $row['va_100k_female'] }}">
                                    ...
                                    <td class="lml-hr-va-cell lml-hr-va-cell--num" data-value="{{ $row['va_100k_total'] }}">
                                    ...
                                    <td class="lml-hr-va-cell lml-hr-va-cell--num" data-value="{{ $row['va_200k_male'] }}">
                                    ...
                                    <td class="lml-hr-va-cell lml-hr-va-cell--num" data-value="{{ $row['va_200k_female'] }}">
                                    ...
                                    <td class="lml-hr-va-cell lml-hr-va-cell--num" data-value="{{ $row['va_200k_total'] }}">
                                    ...
                                    <td class="lml-hr-va-cell lml-hr-va-cell--num lml-hr-va-cell--pct" data-value="{{ $row['percentage'] }}">

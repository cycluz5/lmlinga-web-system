...
@section('content')
    ...
    >
        ...
        @endif
        @error('status')
            <p class="lml-hr-death-form__error" role="alert" data-death-status-error>{{ $message }}</p>
        @enderror
        ...
        <article class="lml-dr-verify__card">
            ...
            <dl class="lml-hr-death-form__details lml-dr-verify__details">
                ...
                <div>
                    ...
                    <dd>{{ $deathRequest->displayRegistryNo() !== '' ? $deathRequest->displayRegistryNo() : HealthRecordsDeath::EMPTY }}</dd>
                </div>
                <div>
                    <dt>Submitted By</dt>
                ...
                @if ($deathRequest->reviewed_at)
                    ...
                    <div>
                        <dt>Reviewed On</dt>
                        <dd>{{ \App\Support\DisplayDate::formatDateTime($deathRequest->reviewed_at) }}</dd>
                    </div>
                @endif

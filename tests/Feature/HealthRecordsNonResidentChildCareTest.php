...
class HealthRecordsNonResidentChildCareTest extends TestCase
{
    ...
    {
        $this->actingAsStaff(StaffRole::BHW);
        $response = $this->get(route('health-records.child-care.non-residents.index'));
        ...
        $this->assertStringContainsString('data-hr-cc-nr-back', $html);
        $this->assertStringContainsString(
            'href="'.e(route('health-records.child-care.index')).'"',
            $html
        );
        $this->assertMatchesRegularExpression(
            '/data-hr-cc-nr-back[^>]*>[\s\S]*?>\s*Back\s*<\/span>/u',
            $html
        );
    ...
    public function test_listing_excludes_residents_and_includes_non_residents(): void
    {
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $html = $this->get(route('health-records.child-care.non-residents.index'))
            ->getContent();
    ...
    public function test_view_uses_non_resident_destination_not_household_member(): void
    {
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $listing = $this->get(route('health-records.child-care.non-residents.index'));
        $this->assertStringContainsString('href="'.e($expected).'"', $listing->getContent());

        $this->actingAsStaff(StaffRole::BHW);
        $show = $this->get($expected);
        $show->assertOk();
    ...
    public function test_show_page_displays_selected_child_profile_and_dashboard(): void
    {
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $andreiHtml = $this->get(route('health-records.child-care.non-residents.show', [
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $sofiaHtml = $this->get(route('health-records.child-care.non-residents.show', [
    ...
    public function test_resident_records_cannot_open_through_non_resident_route(): void
    {
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $html = $this->get(route('health-records.child-care.non-residents.show', [
    ...
    public function test_nutrition_history_and_measurement_destinations_resolve(): void
    {
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $nutrition = $this->get($nutritionUrl);
        $nutrition->assertOk();
        ...
        $this->assertStringContainsString('06/12/2026', $nutritionHtml);
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $empty = $this->get(route('health-records.child-care.non-residents.nutrition', [
    ...
    public function test_view_nutritional_summary_uses_first_measurement_while_history_keeps_later_records(): void
    {
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $showHtml = $this->get(route('health-records.child-care.non-residents.show', [
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $nutritionHtml = $this->get(route('health-records.child-care.non-residents.nutrition', [
                'childKey' => 'crisley-f-fernando',
            ]))
            ->assertOk()
            ->getContent();
        ...
        $this->assertStringContainsString('11/01/2025', $nutritionHtml);
        $this->assertStringContainsString('02/01/2026', $nutritionHtml);
        $this->assertStringContainsString('07/01/2026', $nutritionHtml);
    ...
    {
        $this->actingAsStaff(StaffRole::BHW);
        $html = $this->get(route('health-records.child-care.non-residents.nutrition', [
        ...
        $this->assertStringContainsString('01/15/2025', $html);
        $this->assertStringContainsString('08/15/2025', $html);
        $this->assertStringContainsString('06/15/2026', $html);
        ...
        $this->assertStringContainsString('01/15/2025', $infantHtml);
        $this->assertStringContainsString('7.4 kg', $infantHtml);
        $this->assertStringNotContainsString('08/15/2025', $infantHtml);
        $this->assertStringNotContainsString('06/15/2026', $infantHtml);
        ...
        $this->assertStringContainsString('08/15/2025', $childHtml);
        $this->assertStringContainsString('06/15/2026', $childHtml);
        $this->assertStringContainsString('9.1 kg', $childHtml);
        $this->assertStringContainsString('11.4 kg', $childHtml);
        $this->assertStringNotContainsString('01/15/2025', $childHtml);
    ...
    public function test_immunization_school_based_and_child_nutrition_are_child_scoped(): void
    {
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $bh = $this->get($bhUrl.'?from=immunization');
        $bh->assertOk();
        ...
        foreach (['immunization', 'school-based-immunization', 'child-nutrition'] as $suffix) {
            $this->actingAsStaff(StaffRole::BHW);
        $resident = $this->get('/health-records/child-care/non-residents/kristine-b-reyes/'.$suffix);
            $resident->assertOk();
    ...
    public function test_deworming_record_and_create_pages_resolve_for_selected_child(): void
    {
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $empty = $this->get(route('health-records.child-care.non-residents.deworming', [
                'childKey' => 'roselyn-a-mendoza',
            ]));
        $empty->assertOk();
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $resident = $this->get(route('health-records.child-care.non-residents.deworming', [
                'childKey' => 'kristine-b-reyes',
            ]));
        $resident->assertOk();
    ...
    public function test_edit_personal_information_page_prefills_selected_non_resident_child(): void
    {
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $sofia = $this->get(route('health-records.child-care.non-residents.edit', [
                'childKey' => 'sofia-l-navarro',
            ]))
            ->assertOk()
            ->getContent();
        ...
        $this->actingAsStaff(StaffRole::BHW);
        $resident = $this->get(route('health-records.child-care.non-residents.edit', [
                'childKey' => 'kristine-b-reyes',
            ]));
        $resident->assertOk();
        $residentHtml = $resident->getContent();
    ...
    public function test_resident_child_care_summary_does_not_use_household_catalog(): void
    {

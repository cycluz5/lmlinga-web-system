...
class HouseholdProfilingFamilyPlanningTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        PersistCatalogHousehold::persistFamilyPlanningVisits('HH-151', 'MB-002');

        $household = \App\Models\Household::query()->where('household_no', 'HH-151')->firstOrFail();
    ...
    public function test_named_routes_resolve_under_household_profiling_member(): void
    {
        ...
        $this->assertSame(
            url('/household-profiling/HH-151/members/MB-002/family-planning'),
            route('household-profiling.members.family-planning.index', $params)
        );
        $this->assertSame(
            url('/household-profiling/HH-151/members/MB-002/family-planning/create'),
            route('household-profiling.members.family-planning.create', $params)
        );
        $this->assertSame(
            url('/household-profiling/HH-151/members/MB-002/family-planning/FP-001'),
            route('household-profiling.members.family-planning.show', $params + ['visitId' => 'FP-001'])
        );
        $this->assertSame(
            url('/household-profiling/HH-151/members/MB-002/family-planning/FP-001/edit'),
    ...
    public function test_history_screen_renders_for_resident_with_fixture_rows(): void
    {
        ...
        $this->assertStringContainsString('10/08/2025', $html);
    ...
    {
        $visits = DemoFamilyPlanning::forMember('HH-151', 'MB-002');
        ...
        $this->assertSame('06/08/2026', $stats['last_visit_label']);
    }
    ...
    public function test_date_filter_this_year_limits_rows(): void
    {
        ...
        $this->assertStringContainsString('06/08/2026', $html);
        $this->assertStringContainsString('05/01/2026', $html);
        $this->assertStringNotContainsString('10/08/2025', $html);
    }

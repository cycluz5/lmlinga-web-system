...
/**
 * Demo-only Death Information session helpers.
 *
 * Persisted DB residents use DeathRequest / death_records as the sole authority.
 * This session store must not override, supplement, or write that table.
 * Keep session create/edit only for DemoCatalog members that are not in the database.
 */

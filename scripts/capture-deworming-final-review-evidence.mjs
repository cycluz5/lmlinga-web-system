/**
 * Deworming — final independent-review evidence capture.
 *
...
const outDir = path.join(
    ...
    'qa',
    'evidence',
    'health-records-deworming-final-review'
);
...
const shots = [
    { id: 'DW-E1', file: 'DW-E1-desktop-1440x900.png', w: 1440, h: 900 },
    { id: 'DW-E2', file: 'DW-E2-desktop-1366x768.png', w: 1366, h: 768 },
    { id: 'DW-E3', file: 'DW-E3-tablet-820x1180.png', w: 820, h: 1180 },
    { id: 'DW-E4', file: 'DW-E4-tablet-768x1024.png', w: 768, h: 1024 },
    { id: 'DW-E5', file: 'DW-E5-mobile-390x844.png', w: 390, h: 844 },
    { id: 'DW-E6', file: 'DW-E6-mobile-360x800.png', w: 360, h: 800 },
];
...
<body>
  ...
  <img class="cdt-frame" id="frame" alt="Deworming page at ${w}×${h}">
</body>
</html>`;
}

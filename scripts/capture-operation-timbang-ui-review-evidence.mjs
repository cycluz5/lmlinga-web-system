/**
 * Operation Timbang — UI-review evidence capture.
 *
 ...
 * so reviewers can verify size from the image itself.
 *
...
const outDir = path.join(
    ...
    'qa',
    'evidence',
    'health-records-operation-timbang-ui-review'
);
...
const shots = [
    { id: 'OT-E1', file: 'OT-E1-desktop-1440x900.png', w: 1440, h: 900 },
    { id: 'OT-E2', file: 'OT-E2-desktop-1366x768.png', w: 1366, h: 768 },
    { id: 'OT-E3', file: 'OT-E3-tablet-820x1180.png', w: 820, h: 1180 },
    { id: 'OT-E4', file: 'OT-E4-tablet-768x1024.png', w: 768, h: 1024 },
    { id: 'OT-E5', file: 'OT-E5-mobile-390x844.png', w: 390, h: 844 },
    { id: 'OT-E6', file: 'OT-E6-mobile-360x800.png', w: 360, h: 800 },
];
...
<style>
  * { box-sizing: border-box; }
  ...
  /* Chrome DevTools Device Toolbar — visible evidence chrome */
  .cdt-device-toolbar {
    height: ${TOOLBAR_H}px;
    display: flex;
    align-items: center;
...
<body>
  ...
  <img class="cdt-frame" id="frame" alt="Operation Timbang page at ${w}×${h}">
</body>
</html>`;
}
    ...
    JSON.stringify(
        {
            ...
            url,
            note: 'Each PNG includes a visible Chrome DevTools Device Toolbar chrome with exact CSS viewport W×H in the dimension fields.',
            measurements,
        },
        null,
        2

...
class HealthRecordsSidebarNavigationTest extends TestCase
{
    ...
    public function test_health_records_children_do_not_use_hash_placeholders(): void
    {
        ...
        $this->assertSame(
            ...
            'Until Family Planning / Maternal / Death destinations exist, three children must render as non-navigating items.'
        );
        $this->assertSame(
            3,
    ...
    public function test_canonical_health_records_child_routes_partial_availability(): void
    {
        ...
        foreach (['family-planning', 'maternal', 'death'] as $childKey) {
            $this->assertFalse(
